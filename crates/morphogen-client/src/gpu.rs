...
pub use morphogen_gpu_dpf::dpf::{generate_chacha_dpf_keys, ChaChaKey, ChaChaParams};
...
pub fn generate_gpu_page_query(
    ...
    let num_rows = num_pages.checked_mul(ROWS_PER_PAGE).ok_or(
        morphogen_gpu_dpf::dpf::GpuDpfError::InvalidDomainBits {
            bits: domain_bits,
