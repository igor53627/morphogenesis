...
2.15~billion rows) is stored in GPU VRAM and scanned via a fused AES$\oplus$XOR
CUDA kernel achieving 2,143~GB/s throughput and 32.1~ms latency on NVIDIA H100.
...
\paragraph{Workspace.}
The implementation is organized as a Rust workspace with eight crates
...
\begin{itemize}
  \item Fused AES$\oplus$XOR kernel on H100 VRAM (68.8\,GB).
